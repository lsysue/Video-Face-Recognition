...
# 从人脸图像文件中提取人脸特征存入 "known_features.csv" / Extract features from images and save into "known_features.csv"
...
path_images_from_camera = cfg.rgst_face_dir
...
def main():
    ...
    with open("data/known_features.csv", "w", newline="") as csvfile:
        ...
        for person in range(person_cnt):
            ...
            logging.info('\n')
        logging.info("所有录入人脸数据存入 / Save all the features of faces registered into: data/known_features.csv")
